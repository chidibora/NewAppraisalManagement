...
const Competency = ({ history }) => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = 'EDSG - Approver Route';
      ...
      <div className="table-view m-t-10">
        <div className="table-header">
          <div className="table-row">
            <div className="th"><p className="san-sherif">Competency</p></div>
            <div className="th"><p className="san-sherif">Category</p></div>
