...
import AssessmentForm from '../layouts/AssessmentForm';

const Assessment = ({ history, details = {} }) => {
  ...
  return (
    <div className="w-100">
      ...
      <div className="w-100 flex space-between m-t-20 flex-v-center">
        <h4 className="san-sherif">Quality Assessment</h4>
        <SearchInput placeholder="Search transactions, invoices or help" />
      </div>
      <div className="table-view m-t-10">
        <div className="table-header">
          <div className="table-row">
            <div className="th"><p className="san-sherif">Questions</p></div>
      ...
      {showFormModal && <AssessmentForm closeModal={() => setShowFormModal(false)} />}
    </div>
  );
};
